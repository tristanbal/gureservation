...
<div class="container">
                    ...
                    <div class="card-body">
                        <table>
                            ...
                            <td class="align-top">
                                    ...
                                    <h3><b><?php echo date('F d',strtotime($startDateNext)); ?> - <?php echo date('d, Y', strtotime($endDateNext));?></b></h3>
                                <p> Time: <b><?php echo date('h:mA',strtotime($reserveStartTime));?> - <?php echo date('h:mA',strtotime($reserveEndTime));?></b>
                                <br>
                                <br>
                                Title: <b>{{$title}}</b><br>
    ...
    <div class="row">
        ...
        <div class="col-7">
            ...
            <input type="text" value="{{$personInCharge}}" name="personInCharge" hidden>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Our catering schedule is as follows:</p>
                            <ul>
                                <table class="table">
                                    <tr>
                                        <th>Breakfast:</th>
